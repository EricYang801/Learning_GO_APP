...
#ifndef RECORD_IOS_SWIFT_H
#define RECORD_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="record_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10record_ios15RecordIosPlugin")
@interface RecordIosPlugin : NSObject <FlutterPlugin>
...
@class FlutterError;
SWIFT_CLASS("_TtC10record_ios19RecordStreamHandler")
...
SWIFT_CLASS("_TtC10record_ios18StateStreamHandler")
